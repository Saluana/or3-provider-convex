...
export const convexInternalApiContractNames = [
    ...
    'backgroundJobs:listPendingHistory',
    'backgroundJobs:renewLease',
    'backgroundJobs:saveTerminalSnapshot',
    'backgroundJobs:setHistoryPhase',
    'backgroundJobs:update',
    'backgroundJobs:updateExecution',
    ...
    'sync:gcChangeLog',
    'sync:gcTombstones',
    'sync:admitChatGeneration',
    'sync:finalizeChatGeneration',
    'sync:runScheduledGc',
    'sync:runWorkspaceGc',
